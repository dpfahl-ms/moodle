...
class webdav_client {
     ...
     */
    public function search(string $path, string $username, string $query, array $properties = []): array|bool {
        // Validate parameters.
        try {
            ...
            // Escape literal pattern signs in the query to prevent issues.
        ...
        $xmlwriter->endElement(); // End of d:prop.
        $xmlwriter->endElement(); // End of d:select.
        ...
        $xmlwriter->endElement(); // End of d:scope.
        $xmlwriter->endElement(); // End of d:from.
        ...
        $xmlwriter->endElement(); // End of d:like.
        $xmlwriter->endElement(); // End of d:where.

        // Order by (empty).
        $xmlwriter->writeElement('d:orderby');

        $xmlwriter->endElement(); // End of d:basicsearch.
        $xmlwriter->endElement(); // End of d:searchrequest.
